        ...
        <mat-card-content>
          <form [formGroup]="registerForm" (ngSubmit)="onSubmit()">
            ...
            <div class="password-hints" *ngIf="registerForm.get('password')?.dirty">
              <span [class.met]="!registerForm.get('password')?.hasError('minlength')">✓ 8+ characters</span>
              <span [class.met]="!registerForm.get('password')?.hasError('noUppercase')">✓ Uppercase</span>
              <span [class.met]="!registerForm.get('password')?.hasError('noLowercase')">✓ Lowercase</span>
              <span [class.met]="!registerForm.get('password')?.hasError('noNumber')">✓ Number</span>
              <span [class.met]="!registerForm.get('password')?.hasError('noSpecial')">✓ Special char</span>
            </div>
